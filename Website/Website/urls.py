...
urlpatterns = [
    ...
    path("about/", blog_views.about_page, name="about"),
    path("speed-reader/", blog_views.speed_reader_page, name="speed-reader"),
    path("links/", blog_views.links_page, name="links"),
